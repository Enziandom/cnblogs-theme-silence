...
function createPostTitle() {
  ...
  $(".control-font-size").on("click", () => {
    fontSize++;
    if (fontSize > options.postFontSize.max) {
      fontSize = options.postFontSize.min;
    }
    $("#topics .postBody").css({
      "font-size": fontSize + "px"
    });
