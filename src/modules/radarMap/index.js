...
import { RadarMapCreator } from "./js/radarmap-creator";
...
function initRadarMap() {
  ...
  if ( !isLoaded ) {
    new Promise(function (resolve, reject) {
      ...
      setTimeout(() => {
        let radarMapCreator = new RadarMapCreator(ctx, 100, 100, options.radarMap, {
          fillColor, strokeColor
        });
        let axis = radarMapCreator.drawRadarMap();
        radarMapCreator.drawFloatingPanel(axis);
        resolve();
      }, 1200);
    }).then(() => {
